    ...
    class Meta:
        ...
        widgets = {
            ...
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Name", "required": True}
            ),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "subject": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Your subject here"}
            ),
            "phone": forms.NumberInput(
                attrs={"class": "form-control", "placeholder": "Your phone here"}
            ),
