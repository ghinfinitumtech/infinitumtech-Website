...
class Services(models.Model):
    name = models.CharField(max_length=100)
    banner_image = models.ImageField(upload_to="services/banner",default="img/banner/page-title.jpg")
    ...
    technology = models.ForeignKey(Technologie, on_delete=models.CASCADE, null=True, blank=True)
